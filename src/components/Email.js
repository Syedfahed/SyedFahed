...
<div className='container border email-box'>
    ...
    <form className='form' onSubmit={sendEmail}>
        <label>Name</label>
        <input inputMode='text' placeholder='username'  name="name" className='form-control'></input>
        <label>Email</label>
        <input placeholder='username@gmail.com'  name="user_email" className='form-control'/>
        <label>Message</label>
